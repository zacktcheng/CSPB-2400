...
All coding & file handins are electronic via GitHub Classroom.  Clarifications and corrections will be posted on the course page or Moodle. 
The report needs to be submitted on Gradescope, and grading will follow.
...
Conversion to 40% of DataLab grading (the remaining 60% will come from GitHub commit history and Report)
Execution Grade = 40
Execution Extra = 4
```
...
The assignment is scored in two parts - you will receive 40 percent of the overall score for having correctly functioning functions handed in on time and 60 percent for being able to show GitHub commit history credibility and correctly explain how your functions work in your report and how to generalize those solutions.
